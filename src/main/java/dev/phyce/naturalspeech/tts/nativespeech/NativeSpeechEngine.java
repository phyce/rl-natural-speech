...
public class NativeSpeechEngine {
	...
	private NativeSpeechEngine(NativeSpeechProcess process, PlaybackGate playbackGate,
	...
	public static NativeSpeechEngine start(PlaybackGate playbackGate, IntSupplier dialogGenSupplier)
		throws IOException {
		return new NativeSpeechEngine(NativeSpeech.startProcess(), playbackGate, dialogGenSupplier);
	}
