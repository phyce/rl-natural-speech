...
public final class PluginResources {
	...
	public static final ImageIcon MAIN_SETTINGS_ICON =
			new ImageIcon(ImageUtil.loadImageResource(PluginResources.class, "NPC_Contact.png"));
	@NonNull
	...
	public static final ImageIcon VOICE_HUB_ICON =
			new ImageIcon(ImageUtil.loadImageResource(PluginResources.class, "Clarity_of_Thought.png"));
	@NonNull
