...
public class SpeakerExplorerPanel extends PluginPanel {
    ...
    void searchFilter(String search) {
        ...
        Set<String> searchTerms = Arrays.stream(search.toLowerCase().split("[,\\s]+"))
        ...
        search = StringUtils.join(searchTerms, " ");
        ...
        for (Component comp : speakerListPanel.getComponents()) {
            ...
            if (gender != null && !gender.equals(speaker.getGender())) {
                visible = false;
            }
            ...
            if (!searchTerms.isEmpty()) {
                ...
                if (speaker.getName().toLowerCase().contains(search)) {
                    term_matched = true;
                }
            }
