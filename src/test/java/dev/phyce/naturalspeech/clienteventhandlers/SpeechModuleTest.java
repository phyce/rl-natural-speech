...
//
//	@Inject
//	SpeechModule speechEventHandler;
//
//	@Inject
...
//		lenient().when(speechManager.isAlive()).thenReturn(true);
...
//		lenient().when(speechManager.isAlive()).thenReturn(false); // engine not running
//
...
//
//		///////
//		String lineName = MagicNames.DIALOG;
